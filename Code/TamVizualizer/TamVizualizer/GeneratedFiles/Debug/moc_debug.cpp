...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Debug_t, stringdata) + ofs \
...
const QMetaObject Debug::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Debug.data,
      qt_meta_data_Debug,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Debug::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Debug.stringdata))
